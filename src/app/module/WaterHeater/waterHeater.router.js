...
const { createWaterHeater, getWaterHeaters, getWaterHeaterById, updateWaterHeater, deleteWaterHeater } = require('./waterHeater.controller');
const { authenticateUser } = require('../../middleware/auth.middleware');
const upload = require('../../../utils/uploadConfig');

router.post('/create', authenticateUser, upload.array('images'), createWaterHeater);
router.get('/get', authenticateUser, getWaterHeaters);
